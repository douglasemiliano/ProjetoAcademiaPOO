	...
	while (!sair) {	
			...
			case 1:
				...
				while (!saira) {
					...
					int escolhaA = Integer.parseInt(JOptionPane.showInputDialog("Menu Academia " + academia.getNome() + "\n"+
							"1 - Contas a receber\n"+
							"2 - Contas a pagar\n"+
							"0 - Sair"));
			...
			case 2:
				...
				boolean sairf = false;
				while (!sairf) {
					int escolhaf = Integer.parseInt(JOptionPane.showInputDialog("Menu Funcionarios " + academia.getNome() + "\n"+
							"1 - Cadastrar\n"+
							"2 - Listar\n"+
							"3 - A Pagar\n"+
							"4 - Efetuar Pagamento \n"+
			...
			case 4: //cliente
				boolean sairc = false;
				while (!sairc) {
					int escolhaf = Integer.parseInt(JOptionPane.showInputDialog("Menu Clientes " + academia.getNome() + "\n"+
							"1 - Cadastrar\n"+
							"2 - Listar\n"+
							"3 - A Receber\n"+
							"4 - Efetuar Pagamento \n"+
